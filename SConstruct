...
if env["platform"] == "macos":
    library = env.SharedLibrary(
        "fsm-demo/addons/node_state_controller/bin/libstate_machine.{}.{}.framework/libstate_machine.{}.{}".format(
    ...
    library = env.SharedLibrary(
        "fsm-demo/addons/node_state_controller/bin/libstate_machine{}{}".format(
